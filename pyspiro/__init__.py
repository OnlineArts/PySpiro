...
from .src.spirometry.PRATA_2018 import PRATA_2018
...
# SATS correction helper — not a reference equation, so excluded from the chronological list above
from .src.spirometry.KOEGELENBERG_2013 import KOEGELENBERG_2013
